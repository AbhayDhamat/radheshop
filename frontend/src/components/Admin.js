...
const AddProduct = () => {
  ...
  const apiEndpoints = {
    fruits: "https://radheshop-backend.onrender.com/api/fruits",
    vegetables: "https://radheshop-backend.onrender.com/api/vegetables",
    dairy: "https://radheshop-backend.onrender.com/api/milk-products",
  };
